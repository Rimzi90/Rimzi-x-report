...
# === ANIMATED BANNER ===
def show_banner():
    banner1 = pyfiglet.figlet_format("Rimzi-X Report", font="slant")
    ...
    for _ in range(2):
        for color in [Fore.RED, Fore.YELLOW, Fore.CYAN, Fore.MAGENTA, Fore.GREEN, Fore.BLUE]:
            ...
            print(Fore.LIGHTMAGENTA_EX + "     Made by Rimzi     ".center(80))
            time.sleep(0.1)
    print(Fore.LIGHTYELLOW_EX + "="*80)
    print(Fore.CYAN + "Instagram Rimzi-X Maas Report Tool".center(80))
    print(Fore.LIGHTYELLOW_EX + "="*80 + "\n")
    time.sleep(0.5)
